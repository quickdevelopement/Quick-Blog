        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('dashboard') }}" class="flex ms-2 md:me-24">
                    <img src="/logo/quick-development.png" class="h-8 me-3" alt="Quick Blog Logo" />
                    <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Quick
                        Blog</span>
                </a>
            </div>
