         ...
         <div class="p-4 sm:ml-64 ">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                <div class="grid grid-cols-3 gap-4 mb-4">
                    ...
                    <div class="flex items-center  justify-center h-24 rounded-sm bg-gray-50 dark:bg-gray-800">
                        <a href="{{ route('categories.create.get') }}" class="text-2xl border-dashed border-green-500 border-2 leading-22 rounded h-full w-full text-center text-green-600 dark:text-green-600">
                            Create Category
                        </a>
                    </div>
                </div>
                                    ...
                                    @foreach ($categories as $category)
                                        <tr
                                            ...
                                            <td class="px-6 py-4 flex gap-2">
                                                ...
                                                <a href="{{ route('categories.edit.get', $category->id) }}"
