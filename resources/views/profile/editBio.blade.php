        ...
        <div class="p-4 sm:ml-64 mt-14 ">
            <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 ">
                ...
                <div class="  mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
                    ...
                    <div class="text-2xl  text-gray-400 dark:text-gray-500" id="bio-text">
                        <form class="w-full " id="bio-form" method="POST" action="{{ route('profile.bioUpdate') }}">
                            @csrf
                            @method('PATCH')
                            <div
                                class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                                <div
                                    class="flex items-center justify-between px-3 py-2 border-b  dark:border-gray-600 border-gray-200">
                                    <div
                                ...
                                <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                    ...
                                    <textarea id="editor" rows="8" name="bio"
